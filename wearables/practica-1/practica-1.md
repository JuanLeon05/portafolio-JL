...
Topología en paralelo, lista de materiales y esquema de conexiones.
[Ver Hardware](./hardware.md){: .btn .btn-primary .mr-2 }

### 2. Cálculos y Ley de Ohm
Análisis matemático para la selección de las 5 resistencias.
[Ver Cálculos](./calculos.md){: .btn .btn-primary .mr-2 }

### 3. Proceso de Manufactura
Técnicas de costura conductiva, iteraciones y ensamble.
[Ver Proceso](./proceso.md){: .btn .btn-primary .mr-2 }

### 4. Diseño y Estética
Concepto, intención de diseño y experiencia de usuario.
[Ver Diseño](./diseno.md){: .btn .btn-primary .mr-2 }

### 5. Evidencia Multimedia
Registro fotográfico y en video del funcionamiento y construcción.
